...
export const SearchResult = () => {
    ...
    console.log('Search term from previous page:', searchTerm);
    useEffect(() => {
        ...
        <div className='all'>
            ...
            <div>
                <div className='result'>
                    <div style={{ fontSize: 16, paddingTop: 20, marginRight: 20 }}>Xem tất cả 1 kết quả</div>
                    <div>
                        <form >
                ...
                {isLoading ? <Box sx={{ display: 'flex', height: '500px', alignItems: 'center' }}>
                    <CircularProgress />
                </Box> : <div style={{ display: 'flex', flexWrap: 'wrap', overflow: 'hidden', marginRight: 600 }}>
